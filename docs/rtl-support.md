...
| Web/wasm and browsers | **Untested** | The demo app and embedded fixture loader compile for `wasm32-unknown-unknown`; no browser interaction or rendering was run. | [E5](rtl-validation.md#e5-reproducible-font-fixtures), [V19](rtl-validation.md#v19-wasm-and-browser) | [interactive demo task](https://taskum.com/project/egui-rtl-fixes/issue/rtl-docs-examples/task/02-interactive-demo), [performance and wasm size](https://taskum.com/project/egui-rtl-fixes/issue/rtl-performance-wasm) |
