...
| Arabic and Hebrew shaping | **Partial** | Harfrust shapes runs with the resolved direction. A local probe verified contextual Arabic forms and distinct Hebrew glyphs with pinned Noto files. Persian, Urdu, fallback transitions, ligatures, and broader script coverage remain untested. | [E2](rtl-validation.md#e2-real-font-shaping), [source](https://github.com/abdu-benayad/egui/blob/c93e8863e958507056415e2a6dace56e23ba5f3a/crates/epaint/src/text/text_layout.rs#L1854-L1901) | [script shaping and font fallback](https://taskum.com/project/egui-rtl-fixes/issue/script-shaping-font-fallback), [font fixtures task](https://taskum.com/project/egui-rtl-fixes/issue/rtl-docs-examples/task/04-reproducible-font-fixtures) |
| Bundled font coverage | **Unsupported** | The default test fonts do not cover Hebrew; the in-tree bidi tests intentionally exercise `.notdef` glyphs. Applications must supply suitable fonts. No reproducible RTL fixture is committed yet. | [E1](rtl-validation.md#e1-bundled-font-bidi-layout), [source](https://github.com/abdu-benayad/egui/blob/c93e8863e958507056415e2a6dace56e23ba5f3a/crates/epaint/src/text/text_layout.rs#L2798-L2808) | [font fixtures task](https://taskum.com/project/egui-rtl-fixes/issue/rtl-docs-examples/task/04-reproducible-font-fixtures) |
...
| Linux native | **Untested** | Headless unit probes ran on x86_64 Linux. No application interaction or renderer screenshot was checked, so native rendering and editing remain untested. | [environment](rtl-validation.md#environment) | [interactive demo task](https://taskum.com/project/egui-rtl-fixes/issue/rtl-docs-examples/task/02-interactive-demo), [RTL IME and platform input](https://taskum.com/project/egui-rtl-fixes/issue/rtl-ime-platform-input) |
...
| Web/wasm and browsers | **Untested** | No wasm build or browser interaction was run. | [V19](rtl-validation.md#v19-wasm-and-browser) | [interactive demo task](https://taskum.com/project/egui-rtl-fixes/issue/rtl-docs-examples/task/02-interactive-demo), [performance and wasm size](https://taskum.com/project/egui-rtl-fixes/issue/rtl-performance-wasm) |
| glow, wgpu, and other renderers | **Untested** | Layout assertions did not render pixels. No renderer-specific snapshot was inspected. | [V18](rtl-validation.md#v18-native-platforms-and-renderers) | [foundation landing](https://taskum.com/project/egui-rtl-fixes/issue/land-pr-8577-foundation), [interactive demo task](https://taskum.com/project/egui-rtl-fixes/issue/rtl-docs-examples/task/02-interactive-demo) |
